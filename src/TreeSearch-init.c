...
extern SEXP _TreeSearch_ts_soft_sankoff_test(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
{"_TreeSearch_ts_parallel_resample", (DL_FUNC) &_TreeSearch_ts_parallel_resample, 27},
  ...
  {"_TreeSearch_ts_soft_sankoff_test", (DL_FUNC) &_TreeSearch_ts_soft_sankoff_test, 8},
