...
(returned by
[`MorphyLength()`](https://ms609.github.io/TreeSearch/reference/MorphyTreeLength.md)
...
- Conduct parsimony search using Brazeau, Guillerme & Smith’s [approach
  to inapplicable
  data](https://ms609.github.io/TreeSearch/articles/tree-search.md), or
  using [Profile
...
- [Mapping the space of optimal
  trees](https://ms609.github.io/TreeSearch/articles/tree-space.md)
