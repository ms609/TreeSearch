...
| T-130 | Shiny: Search cancellation button | B | Already fully implemented by T-137/T-138 changes: hidden Stop button, file-based cancel signal, C++ polling in serial/parallel paths, cleanup on completion. 3 testServer tests, 38/38 mod-search pass. |
