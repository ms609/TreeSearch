...
Destroys an instance of the Morphy object, calling all destructor for
internal object completely returning the memory to the system.

## Usage

``` r
mpl_delete_Morphy(morphyobj)
```
...
- morphyobj:
  ...
  A Morphy object to be destroyed.
