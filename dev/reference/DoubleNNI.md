...
- edgeToBreak:
  ...
  In
  (`Rooted`/`Double`)[`NNI()`](https://ms609.github.io/TreeSearch/dev/reference/NNI.md),
  ...
  an integer from zero to `nEdge(tree) - nTip(tree) - 2`, specifying
  which internal edge to break.
