...
- char:
  ...
  State of each character at each tip in turn, in a format that will be
  converted to a character string by
  [`paste0`](https://rdrr.io/r/base/paste.html)`(char, ";", collapse="")`.
...
A pointer to an object of class `morphyObj`. Don't forget to unload it
