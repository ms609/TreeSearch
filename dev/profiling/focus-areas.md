...
| 4  | TBR full-rescore at acceptance      | `src/ts_tbr.cpp:1138` (`full_rescore` after every accepted move)       | T-300 — O(n_node × total_words) per accepted move; replaceable by incremental rescore         | 19.2 % of DLL CPU time (VTune 2026-05-19); fitch_na_score 18.2 % + load_tip_states 1.0 %; prior S-PROF est 28 % | 2026-05-19    | PROFILED   |
...
| 6  | CSS / RSS sector pipeline           | `src/ts_sector.cpp`, `src/ts_simplify.cpp` (`ts_simplify_diag` entry)  | CSS 4.4 %, XSS 3.2 %; XSS dataset-dependent (0–27 step Δ); RSS / CSS share infrastructure     | XSS 77 ms/call, CSS 106 ms/call (Zhu2013)        | —             | NEW        |
