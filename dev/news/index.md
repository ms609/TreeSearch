...
- Rename functions
  [`MinimumSteps()`](https://ms609.github.io/TreeSearch/dev/reference/MinimumLength.md)→[`MinimumLength()`](https://ms609.github.io/TreeSearch/dev/reference/MinimumLength.md)
  and
  [`FitchSteps()`](https://ms609.github.io/TreeSearch/dev/reference/FitchSteps.md)→[`CharacterLength()`](https://ms609.github.io/TreeSearch/dev/reference/CharacterLength.md)
...
- [`FitchSteps()`](https://ms609.github.io/TreeSearch/dev/reference/FitchSteps.md)
