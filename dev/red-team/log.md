...
date: 2026-07-24
tier: opus + fable (USER-DIRECTED OVERRIDE — doctrine `start_tier` for area 6 is `sonnet`; this was NOT an organic escalation, so area 6's true sonnet-tier maturity is still unmeasured and the next *organic* visit should still start there unless explicitly overridden again)
