...
| S-PR | dyn | OPEN | — | **Standing: PR maintenance** | Last run: 2026-03-27 by F (round 34). #216 (T-204 native-search): GHA 23644617599 in progress. #213 (T-150 cid-consensus): GHA 23644644554 failed (Consensus case), fixed 0c1f0fe9, re-dispatched 23645305415. Open PRs: #213, #216, #210 (cpp-search→main DRAFT). |
