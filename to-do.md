...
| ID | Pri | Status | Blocks | Description | Notes |
|----|-----|--------|--------|-------------|-------|
| S-RED | dyn | ASSIGNED (D) | — | **Standing: Red-team review** | Last run: 2026-03-25 by B (focus 10: Profile & IW scoring). |
...
| S-COORD | dyn | ASSIGNED (B) | — | **Standing: Coordination review** | Round 18 in progress. |
