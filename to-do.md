...
| ID | Pri | Status | Blocks | Description | Notes |
|----|-----|--------|--------|-------------|-------|
| S-RED | dyn | OPEN | — | **Standing: Red-team review** | Last run: 2026-03-27 focus 17 by F (ts_nni_perturb.cpp, 136+59 lines). Two bugs fixed: F-016 (stale constraint_node before TBR after random_nni_perturb; stale after best_tree revert). commit 2f4f1761. GHA 23653513217. Same class as T-278/T-279/E-003/F-015. Other invariants correct: conflict detection via touched set, impose_constraint safe before update_constraint. Next: ts_resample.cpp or ts_prune_reinsert.cpp. |
