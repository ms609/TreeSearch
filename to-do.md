...
| ID | Pri | Status | Blocks | Description | Notes |
|----|-----|--------|--------|-------------|-------|
| S-RED | dyn | OPEN | — | **Standing: Red-team review** | Last run: 2026-03-27 focus 24 by F (ts_fitch_na.h 288 lines + ts_fitch_na_incr.h 677 lines). No bugs found. Three-pass Brazeau et al. downpass/uppass/Pass3 all correct; incremental NA variants match non-incremental; NA indirect length (any_hit_reduce3_from1, subtree_actives suppression) consistent across all variants. Next: ts_tree.h/.cpp (404+201 lines). |
