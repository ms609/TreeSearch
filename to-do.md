...
| T-256 | P2 | PARKED (F, Hamilton) | — | **Increase sectorial search intensity.** TNT dedicates ~67% of intra-replicate time to sectorial search; TreeSearch's XSS+RSS+CSS takes 6–10% of time but has respectable efficiency (5–20 ms/step). Experiment: double `xssRounds` and `rssRounds`; benchmark on gap datasets (3 seeds, 30s). | Script: `bench_sectorial_intensity.R` in TS-TNT-bench. **No Slurm job or upload script found** — may need fresh Hamilton dispatch. |
