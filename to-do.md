...
| ID | Pri | Status | Blocks | Description | Notes |
|----|-----|--------|--------|-------------|-------|
| S-RED | dyn | OPEN | — | **Standing: Red-team review** | Last run: 2026-03-27 focus 20 by F (ts_simplify.cpp, 382+57 lines). No bugs found. Transforms 2/3 (redundant-ambiguity/singleton removal), uninformativeness check, NA-skip guard all correct. Caterpillar heuristic noted (conservative). Next: ts_search.cpp (SPR/NNI standalone) or ts_data.cpp. |
