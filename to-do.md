...
| ID | Pri | Status | Blocks | Description | Notes |
|----|-----|--------|--------|-------------|-------|
| S-RED | dyn | OPEN | — | **Standing: Red-team review** | Last run: 2026-03-27 focus 25+26 by F (ts_tree, ts_splits, ts_collapsed, ts_hsj, ts_sankoff, ts_rng.h — total ~1909 lines). No bugs. All engine modules reviewed. Next: ts_rcpp.cpp (Rcpp bridge). |
