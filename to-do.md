...
| ID | Pri | Status | Blocks | Description | Notes |
|----|-----|--------|--------|-------------|-------|
| S-RED | dyn | OPEN | — | **Standing: Red-team review** | Last run: 2026-03-27 focus 13 by E (ts_sector.cpp, 1007+88 lines). Bug found and fixed: E-003 (stale constraint_node after accepted sector improvement in rss_search/xss_search — commit f1ad0308). CSS unaffected. from_above HTU, conflict-guided weighting, xss_partition, undo/restore all correct. Next: ts_wagner.cpp or ts_constraint.cpp (per F focus-12 note). |
...
| S-COORD | dyn | OPEN | — | **Standing: Coordination review** | Last run: 2026-03-27 round 36 by E. T-278 done (df3aa71e), E-003 done (f1ad0308, sector constraint staleness). T-204 GHA passed — PR #216 ready for merge. OPEN specific (unparked): T-245, T-269, E-002 → 3 specific OPEN → standing at P2. AltHom T-280..T-288 WORKTREE (TS-AltHom) — human-managed. |
| S-PR | dyn | OPEN | — | **Standing: PR maintenance** | Last run: 2026-03-27 round 39 by E. **ASAN**: `continue-on-error: true` on jobs — PRs unblocked. T-150 (PR #213): GHA 23650002703 still running. T-204 (PR #216): GHA 23649607006 PASSED — ready for merge. T-279: GHA 23650290962 still running. cpp-search T-278/E-003: GHA 23650991803 running. Open PRs: #213 (T-150), #216 (T-204), #210 (DRAFT). |
