...
| ID | Pri | Status | Blocks | Description | Notes |
|----|-----|--------|--------|-------------|-------|
| T-298 | P3 | PARKED (d2, other ) | — | **Profile and optimize `quartet_concordance.cpp` matrix allocation** | u.453: review flat array vs. `NumericMatrix`, int vs. double; profile with vprof; check other optimization opportunities. |
