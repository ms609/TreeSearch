...
| ID | Pri | Status | Blocks | Description | Notes |
|----|-----|--------|--------|-------------|-------|
| S-RED | dyn | OPEN | — | **Standing: Red-team review** | Last run: 2026-03-27 focus 19 by F (ts_prune_reinsert.cpp, 511+65 lines). Two bugs fixed: F-018 (stale constraint before full-tree TBR after expand_and_reinsert; stale after backup revert). commit d4399e2a. GHA 23653782359. All other invariants correct: tip selection, prune_subtree, root swap, build_reduced_dataset, expand_and_reinsert. Next: ts_simplify.cpp or ts_search.cpp. |
