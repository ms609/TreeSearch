...
| ID | Pri | Status | Blocks | Description | Notes |
|----|-----|--------|--------|-------------|-------|
| S-RED | dyn | OPEN | — | **Standing: Red-team review** | Last run: 2026-03-27 focus 25+26 by F (ts_tree 404+201, ts_splits 331+71, ts_collapsed 172+53, ts_hsj 261+74, ts_sankoff 178+107, ts_rng.h 56 — total ~1909 lines). No bugs found. All modules correct. Minor: stale postorder during NA SPR incremental scoring includes clip subtree — accepted approximation (full_rescore is authoritative). HSJ uppass correct. Sankoff downpass/uppass correct. Next: ts_rcpp.cpp (Rcpp bridge — deferred; very large, lower priority given all engine modules reviewed). |
