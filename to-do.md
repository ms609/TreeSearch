...
| ID | Pri | Status | Blocks | Description | Notes |
|----|-----|--------|--------|-------------|-------|
| S-RED | dyn | OPEN | — | **Standing: Red-team review** | Last run: 2026-03-27 focus 18 by F (ts_resample.cpp, 294+95 lines). No bugs found. Bootstrap/jackknife sampling, SA reweighting formula, convergence detection all correct. Minor: n_tips=2 division-by-zero in SA (degenerate). Next: ts_prune_reinsert.cpp or ts_simplify.cpp. |
