...
```{r plot-label-nodes}
par(mar = rep(0.25, 4), cex = 0.75) # make plot easier to read
majCons <- Consensus(bestTrees, p = 0.5)
...
strict <- Consensus(bestTrees, p = 1)
...
plot(Consensus(noWiwaxia), tip.color = Rogue::ColByStability(noWiwaxia))
```
