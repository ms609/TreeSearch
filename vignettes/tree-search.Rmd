...
Tree search uses a purpose-built C++ engine that combines TBR rearrangements,
the parsimony ratchet, tree drifting, sectorial search, and tree fusing into
an efficient driven search pipeline, supporting equal weights, implied weights,
and profile parsimony.
