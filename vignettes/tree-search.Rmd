...
If it were equally parsimonious to place _Halkieria_ as a mollusc (as depicted)
or a brachiopod (with _Lingula_ and _Terebratulina_ close to the outgroup),
then neither interpretation should be considered more or less plausible –
but we would expect to observe more unique most parsimonious trees in which 
_Halkieria_ is a mollusc simply because of the greater uncertainty in the 
placement of taxa such as _Odontogriphus_ and _Wiwaxia_, which corresponds
to a greater number of permutations for trees in which _Halkieria_ is a mollusc.
...
regarding its own position. The best single summary tree is provided
by:
