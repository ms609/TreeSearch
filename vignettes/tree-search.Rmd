...
reach.
Replicates are what buy reach on hard datasets: raising `targetHits` alone does
not help there, because a hard search never accumulates that many hits before
the replicate cap stops it.
