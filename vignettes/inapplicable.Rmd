...
The x-transformation approach [@Goloboff2021b] recodes each hierarchy block
...
| Secondary char. variation | Not modelled | Penalized (via α) | Penalized (via Hamming) |
...
following the maximum-homology philosophy of @Goloboff2021b.
