...
## Implied weighting
Equal weights produces trees that are less accurate and less precise than implied weights [@Smith2019]; equally weighted analysis should never be conducted without also considering the results of implied weights [@Goloboff1997], ideally under a range of concavity constants [cf. @Smith2014].
...
gives poorer results in many settings [@Smith2019].
