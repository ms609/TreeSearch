...
jack.support <- TreeTools::SplitFrequency(strict.consensus, jack.trees) / length(jack.trees)
ape::nodelabels(paste('\n\n', signif(jack.support, 2)), 
                node = as.integer(names(jack.support)),
                col = TreeTools::SupportColour(jack.support), 
