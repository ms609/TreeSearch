...
(`Carter1(1, 3, 3)`), and thus represents
...
If we are told that the character contains three or more steps, then it can
occur on any six-leaf tree, and contains no phylogenetic information.
We are less surprised by this third step, which lost us 0.74 bits of information,
than by the second, which lost 3.54 &minus; 0.74 = 2.81&nbsp;bits from a 
character we otherwise thought to be reliable.
