...
$3 \times 2.58 = 7.75\textrm{ bits}$ of information; it is more probable --
and thus on this view more parsimonious -- than the latter, which represents
$2 \times 5.16 = 10.34\textrm{ bits}$,
even though the third roll of the dice could be construed as an additional
assumption.
