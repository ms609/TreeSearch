...
``` r
mpl_get_charac_weight(charID, morphyobj)
```
...
- charID:
  ...
  Number of the character (i.e. first character is number 1)
...
A list, detailing (item 1) the exact weight of the character; (item 2)
the integer approximation used by Morphy.
