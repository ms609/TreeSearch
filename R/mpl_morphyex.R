...
mpl_delete_Morphy <- function(morphyobj) {
    .Call(`R_wrap_mpl_delete_Morphy`, morphyobj)
}
...
mpl_get_gaphandl <- function (morphyobj) {
  .Call(`R_wrap_mpl_get_gaphandl`, morphyobj)
}
...
mpl_set_gaphandl <- function (handl, morphyobj) {
  .Call(`R_wrap_mpl_set_gaphandl`, handl, morphyobj)
}
...
mpl_init_Morphy <- function(numtaxa, numchars, morphyobj) {
    .Call(`R_wrap_mpl_init_Morphy`, as.integer(numtaxa), as.integer(numchars),
          morphyobj)
}
...
mpl_get_numtaxa <- function(morphyobj) {
    .Call(`R_wrap_mpl_get_numtaxa`, morphyobj)
}
...
mpl_set_charac_weight <- function (charID, weight, morphyobj) {
  .Call(`R_wrap_mpl_set_charac_weight`, as.integer(charID - 1L),
...
mpl_get_charac_weight <- function (charID, morphyobj) {
  .Call(`R_wrap_mpl_get_charac_weight`, as.integer(charID) - 1L, morphyobj)
}
...
mpl_get_num_charac <- function(morphyobj) {
  .Call(`R_wrap_mpl_get_num_charac`, morphyobj)
}
...
mpl_attach_symbols <- function(symbols, morphyobj) {
    .Call(`R_wrap_mpl_attach_symbols`, symbols, morphyobj)
}
...
mpl_attach_rawdata <- function(rawdata, morphyobj) {
    .Call(`R_wrap_mpl_attach_rawdata`, rawdata, morphyobj)
}
...
mpl_get_symbols <- function(morphyobj) {
  .Call(`R_wrap_mpl_get_symbols`, morphyobj)  
}
...
mpl_set_parsim_t <- function(char_id, tname = "typename", morphyobj) {
    .Call(`R_wrap_mpl_set_parsim_t`, as.integer(char_id - 1L), tname, morphyobj)
}
...
mpl_set_num_internal_nodes <- function(numnodes, morphyobj) {
    .Call(`R_wrap_mpl_set_num_internal_nodes`, as.integer(numnodes), morphyobj)
}
...
mpl_get_num_internal_nodes <- function(morphyobj) {
    .Call(`R_wrap_mpl_get_num_internal_nodes`, morphyobj)
}
...
mpl_apply_tipdata <- function(morphyobj) {
    .Call(`R_wrap_mpl_apply_tipdata`, morphyobj)
}
...
mpl_first_down_recon <- function(node_id, left_id, right_id, morphyobj) {
    .Call(`R_wrap_mpl_first_down_recon`, as.integer(node_id), as.integer(left_id), as.integer(right_id), morphyobj)
}
...
mpl_first_up_recon <- function(node_id, left_id, right_id, anc_id, morphyobj) {
    .Call(`R_wrap_mpl_first_up_recon`, as.integer(node_id), as.integer(left_id), 
...
mpl_second_down_recon <- function(node_id, left_id, right_id, morphyobj) {
    .Call(`R_wrap_mpl_second_down_recon`, as.integer(node_id), as.integer(left_id),
...
mpl_second_up_recon <- function(node_id, left_id, right_id, anc_id, morphyobj) {
    .Call(`R_wrap_mpl_second_up_recon`, as.integer(node_id), as.integer(left_id), 
                 as.integer(right_id), as.integer(anc_id), morphyobj)
}
...
mpl_update_tip <- function(tip_id, anc_id, morphyobj) {
    .Call(`R_wrap_mpl_update_tip`, as.integer(tip_id), as.integer(anc_id), morphyobj)
}
...
mpl_update_lower_root <- function(l_root_id, root_id, morphyobj) {
    .Call(`R_wrap_mpl_update_lower_root`, as.integer(l_root_id), as.integer(root_id),
                 morphyobj)
}
